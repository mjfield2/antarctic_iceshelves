...
dir_path = Path('G:/antarctic_iceshelves/iceshelves/george')

ds = xr.load_dataset(dir_path/'george.nc')
grav = pd.read_csv(dir_path/'george_grav.csv')
...
print(f'running {n_invs} inversions of George')
