...
dir_path = Path('G:/antarctic_iceshelves/iceshelves/larsen')

ds = xr.load_dataset(dir_path/'larsen.nc')
grav = pd.read_csv(dir_path/'larsen_grav.csv')
...
print(f'running {n_invs} inversions of Larsen')
