...
dir_path = Path('G:/antarctic_iceshelves/iceshelves/salzberger')

ds = xr.load_dataset(dir_path/'salz.nc')
grav = pd.read_csv(dir_path/'salz_grav.csv')
...
print(f'running {n_invs} inversions of Salzberger')
