...
dir_path = Path('G:/antarctic_iceshelves/iceshelves/maudwest')

ds = xr.load_dataset(dir_path/'maudwest.nc')
grav = pd.read_csv(dir_path/'maudwest_grav.csv')
...
print(f'running {n_invs} inversions of Queen Maud Land west')
