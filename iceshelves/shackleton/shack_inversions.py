...
dir_path = Path('G:/antarctic_iceshelves/iceshelves/shackleton')

ds = xr.load_dataset(dir_path/'shack.nc')
grav = pd.read_csv(dir_path/'shack_grav.csv')
...
print(f'running {n_invs} inversions of Shackleton')
