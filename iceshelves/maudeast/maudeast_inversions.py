...
dir_path = Path('G:/antarctic_iceshelves/iceshelves/maudeast')

ds = xr.load_dataset(dir_path/'maudeast.nc')
grav = pd.read_csv(dir_path/'maudeast_grav.csv')
...
print(f'running {n_invs} inversions of Queen Maud Land east')
